...
// MOTOR 2
  ...
  #define MOTOR1_MOTO_EN1 20     // Activalte motor 1 
  #define MOTOR2_MOTO_EN2  20    // Activalte motor 2 
  #define MOTOR3_MOTO_EN3  20    // Activalte motor 1 
  #define MOTOR4_MOTO_EN4  20    // Activalte motor 2 
